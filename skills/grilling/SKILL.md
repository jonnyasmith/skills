---
name: grilling
description: Grill the user relentlessly about a plan, decision, or idea, asking every unblocked question each round. Use when the user wants to stress-test their thinking, wants to be interviewed or grilled, or uses any 'grill' trigger phrases.
---
...
Finding *facts* is your job, never mine. When a frontier question needs a fact from the environment (filesystem, tools, etc.), dispatch a sub-agent to find it — don't ask me for anything you could look up yourself. Don't block on it: a running exploration is an unsettled prerequisite, so only the questions downstream of it wait for the sub-agent to report — ask the rest of the frontier now. The *decisions* are mine — put each one to me and wait for my answer.
